              ...
              {service.images.length > 1 && (
                <div className="flex gap-3 p-4 overflow-x-auto bg-white border-t">
                  {service.images.map((img, i) => (
                    <div
                      key={i}
                      className="relative w-20 h-20 shrink-0 rounded-md overflow-hidden border cursor-pointer hover:ring-2 hover:ring-primary"
                    >
                ...
                <div className="flex items-center gap-4 text-sm text-gray-600">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-medium">
                      {service.seller.avgRating
                        ? Number(service.seller.avgRating).toFixed(1)
                        : "New"}
                    </span>
                    <span className="text-gray-400">
                      ({service.seller.totalReviews || 0} ulasan)
                    </span>
                  </div>
              ...
              <CardContent className="pt-6">
                <Tabs defaultValue="ringkasan" className="w-full">
                  ...
                  >
                    ...
                    {(service.whatsIncluded || service.requirements) && (
                      <Separator />
                    )}
                      ...
                      {service.whatsIncluded && (
                        <div className="bg-emerald-50/50 p-5 rounded-xl border border-emerald-100">
                          <h3 className="text-base font-semibold mb-3 text-emerald-900 flex items-center gap-2">
                            <TbCheck className="h-5 w-5 text-emerald-600" />{" "}
                            Yang Didapat
                          </h3>
                      ...
                      {service.requirements && (
                        <div className="bg-amber-50/50 p-5 rounded-xl border border-amber-100">
                          <h3 className="text-base font-semibold mb-3 text-amber-900 flex items-center gap-2">
                            <TbShield className="h-5 w-5 text-amber-600" />{" "}
                            Persyaratan
                          </h3>
                        ...
                        <div className="space-y-4">
                          {service.faq.map((item, i) => (
                            ...
                            >
                              ...
                              <p className="text-gray-600 pl-4 border-l-2 border-gray-300">
                                A: {item.answer}
                              </p>
                            </div>
                          ))}
                  ...
                  >
                    <div className="flex items-start gap-5 p-6  rounded-xl border">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-5 bg-white border rounded-xl shadow-sm">
                        <p className="text-3xl font-bold text-primary mb-1">
                          {service.seller.totalOrdersCompleted || 0}
                        </p>
            ...
            <div className="sticky top-6">
              ...
              <Card className="border-2 border-primary shadow-lg overflow-hidden relative">
                ...
                <CardContent className="p-6 space-y-6">
                  <div className="text-center">
                    ...
                    <div className="text-3xl font-bold text-gray-900  py-3 rounded-lg border border-gray-100">
              ...
              <div className="mt-6 bg-white p-5 rounded-xl border shadow-sm">
                ...
                <ul className="text-xs space-y-2 text-gray-600 list-disc pl-4">
                  <li>
                    Pastikan judul dan deskripsi jelas & tidak menyesatkan.
                  </li>
